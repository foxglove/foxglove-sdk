...
void declareParameters(rclcpp::Node* node) {
  ...
  auto deviceNameDescription = rcl_interfaces::msg::ParameterDescriptor{};
  deviceNameDescription.name = PARAM_DEVICE_NAME;
  deviceNameDescription.type = rcl_interfaces::msg::ParameterType::PARAMETER_STRING;
  deviceNameDescription.description = "Device name reported to the Foxglove platform";
  deviceNameDescription.read_only = true;
  node->declare_parameter(PARAM_DEVICE_NAME, "foxglove_bridge", deviceNameDescription);
