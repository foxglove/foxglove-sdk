...
/// A channel for logging :py:class:`foxglove.schemas.CompressedPointCloud` messages.
#[pyclass(module = "foxglove.channels")]
struct CompressedPointCloudChannel(Channel<foxglove::schemas::CompressedPointCloud>);
...
impl CompressedPointCloudChannel {
    ...
    /// Log a :py:class:`foxglove.schemas.CompressedPointCloud` message to the channel.
    ///
    /// :param msg: The message to log.
    /// :param log_time: The log time is the time, as nanoseconds from the unix epoch, that the
    ///     message was recorded. Usually this is the time log() is called. If omitted, the
    ...
    fn log(
        &self,
        msg: &schemas::CompressedPointCloud,
        log_time: Option<u64>,
        sink_id: Option<u64>,
    ) {
        let metadata = PartialMetadata { log_time };
...
impl JointStateChannel {
    ...
    /// :param sink_id: The ID of the sink to log to. If omitted, the message is logged to all sinks.
    #[pyo3(signature = (msg, *, log_time=None, sink_id=None))]
    fn log(&self, msg: &schemas::JointState, log_time: Option<u64>, sink_id: Option<u64>) {
        let metadata = PartialMetadata { log_time };
        let sink_id = sink_id.and_then(NonZero::new).map(SinkId::new);
...
impl JointStatesChannel {
    ...
    /// :param sink_id: The ID of the sink to log to. If omitted, the message is logged to all sinks.
    #[pyo3(signature = (msg, *, log_time=None, sink_id=None))]
    fn log(&self, msg: &schemas::JointStates, log_time: Option<u64>, sink_id: Option<u64>) {
        let metadata = PartialMetadata { log_time };
        let sink_id = sink_id.and_then(NonZero::new).map(SinkId::new);
