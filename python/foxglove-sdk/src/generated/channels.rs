...
pub fn register_submodule(parent_module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_class::<EventPropertyChannel>()?;
    module.add_class::<EventTypeChannel>()?;
...
/// A channel for logging :py:class:`foxglove.schemas.Event` messages.
#[pyclass(module = "foxglove.channels")]
struct EventChannel(Channel<foxglove::schemas::Event>);
...
impl EventChannel {
    ...
    /// Log a :py:class:`foxglove.schemas.Event` message to the channel.
    ///
    /// :param msg: The message to log.
    /// :param log_time: The log time is the time, as nanoseconds from the unix epoch, that the
    ///     message was recorded. Usually this is the time log() is called. If omitted, the
    ...
    /// :param sink_id: The ID of the sink to log to. If omitted, the message is logged to all sinks.
    #[pyo3(signature = (msg, *, log_time=None, sink_id=None))]
    fn log(&self, msg: &schemas::Event, log_time: Option<u64>, sink_id: Option<u64>) {
        let metadata = PartialMetadata { log_time };
        let sink_id = sink_id.and_then(NonZero::new).map(SinkId::new);
...
/// A channel for logging :py:class:`foxglove.schemas.EventProperty` messages.
#[pyclass(module = "foxglove.channels")]
struct EventPropertyChannel(Channel<foxglove::schemas::EventProperty>);

#[pymethods]
impl EventPropertyChannel {
    /// Create a new channel.
    ///
    /// :param topic: The topic to log messages to. You should choose a unique topic name per channel.
    /// :param metadata: A dictionary of key/value strings to add to the channel.
    ...
    /// Log a :py:class:`foxglove.schemas.EventProperty` message to the channel.
    ///
    /// :param msg: The message to log.
    /// :param log_time: The log time is the time, as nanoseconds from the unix epoch, that the
    ///     message was recorded. Usually this is the time log() is called. If omitted, the
    ...
    /// :param sink_id: The ID of the sink to log to. If omitted, the message is logged to all sinks.
    #[pyo3(signature = (msg, *, log_time=None, sink_id=None))]
    fn log(&self, msg: &schemas::EventProperty, log_time: Option<u64>, sink_id: Option<u64>) {
        let metadata = PartialMetadata { log_time };
        let sink_id = sink_id.and_then(NonZero::new).map(SinkId::new);
...
/// A channel for logging :py:class:`foxglove.schemas.EventType` messages.
#[pyclass(module = "foxglove.channels")]
struct EventTypeChannel(Channel<foxglove::schemas::EventType>);
...
impl EventTypeChannel {
    ...
    /// Log a :py:class:`foxglove.schemas.EventType` message to the channel.
    ///
    /// :param msg: The message to log.
    /// :param log_time: The log time is the time, as nanoseconds from the unix epoch, that the
    ///     message was recorded. Usually this is the time log() is called. If omitted, the
    ...
    /// :param sink_id: The ID of the sink to log to. If omitted, the message is logged to all sinks.
    #[pyo3(signature = (msg, *, log_time=None, sink_id=None))]
    fn log(&self, msg: &schemas::EventType, log_time: Option<u64>, sink_id: Option<u64>) {
        let metadata = PartialMetadata { log_time };
        let sink_id = sink_id.and_then(NonZero::new).map(SinkId::new);
