...
///       - `step` must be greater than or equal to `width`.
///     - `mono16` or `16UC1`:
///       - 16-bit little-endian integer abstract pixel values. Rendering of these values is controlled in `Image panel color mode settings <https://docs.foxglove.dev/docs/visualization/panels/image#general>`__.
///       - `step` must be greater than or equal to `width` * 2.
///     
///
