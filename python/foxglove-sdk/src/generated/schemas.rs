...
/// :param translation: Translation component of the transform: the position of the child frame's origin expressed in the parent frame.
///     
...
/// :param rotation: Rotation component of the transform: the rotation to apply to convert a point from the child frame to the parent frame
///
