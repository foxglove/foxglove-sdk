...
/// :param velocity_x: Velocity in the north direction (latitude axis) in m/s, positive north.
/// :param velocity_y: Velocity in the east direction (longitude axis) in m/s, positive east.
