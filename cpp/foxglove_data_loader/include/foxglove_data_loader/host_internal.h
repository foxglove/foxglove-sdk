...
typedef struct exports_foxglove_loader_loader_schema_t {
  ...
  host_string_t name;
  // Format for the schema. The well-known schema encodings are preferred. An empty string indicates
...
typedef struct exports_foxglove_loader_loader_message_iterator_t
  exports_foxglove_loader_loader_message_iterator_t;

typedef exports_foxglove_loader_loader_message_iterator_t*
  exports_foxglove_loader_loader_borrow_message_iterator_t;

typedef struct exports_foxglove_loader_loader_own_data_loader_t {
  int32_t __handle;
} exports_foxglove_loader_loader_own_data_loader_t;

typedef struct exports_foxglove_loader_loader_data_loader_t
  exports_foxglove_loader_loader_data_loader_t;

typedef exports_foxglove_loader_loader_data_loader_t*
  exports_foxglove_loader_loader_borrow_data_loader_t;
...
extern uint64_t foxglove_loader_reader_method_reader_seek(
  foxglove_loader_reader_borrow_reader_t self, uint64_t pos
);
extern uint64_t foxglove_loader_reader_method_reader_position(
  foxglove_loader_reader_borrow_reader_t self
);
extern uint64_t foxglove_loader_reader_method_reader_read(
  foxglove_loader_reader_borrow_reader_t self, host_list_u8_t* target
);
extern uint64_t foxglove_loader_reader_method_reader_size(
  foxglove_loader_reader_borrow_reader_t self
);
...
bool exports_foxglove_loader_loader_method_message_iterator_next(
...
bool exports_foxglove_loader_loader_method_data_loader_initialize(
...
bool exports_foxglove_loader_loader_method_data_loader_create_iterator(
  exports_foxglove_loader_loader_borrow_data_loader_t self,
  exports_foxglove_loader_loader_message_iterator_args_t* args,
  exports_foxglove_loader_loader_own_message_iterator_t* ret,
  exports_foxglove_loader_loader_error_t* err
);
bool exports_foxglove_loader_loader_method_data_loader_get_backfill(
  exports_foxglove_loader_loader_borrow_data_loader_t self,
...
extern foxglove_loader_reader_borrow_reader_t foxglove_loader_reader_borrow_reader(
  foxglove_loader_reader_own_reader_t handle
);
...
extern void exports_foxglove_loader_loader_message_iterator_drop_own(
  exports_foxglove_loader_loader_own_message_iterator_t handle
);

extern exports_foxglove_loader_loader_own_message_iterator_t
exports_foxglove_loader_loader_message_iterator_new(
  exports_foxglove_loader_loader_message_iterator_t* rep
);
extern exports_foxglove_loader_loader_message_iterator_t*
exports_foxglove_loader_loader_message_iterator_rep(
  exports_foxglove_loader_loader_own_message_iterator_t handle
);
void exports_foxglove_loader_loader_message_iterator_destructor(
  exports_foxglove_loader_loader_message_iterator_t* rep
);

extern void exports_foxglove_loader_loader_data_loader_drop_own(
  exports_foxglove_loader_loader_own_data_loader_t handle
);

extern exports_foxglove_loader_loader_own_data_loader_t
exports_foxglove_loader_loader_data_loader_new(exports_foxglove_loader_loader_data_loader_t* rep);
extern exports_foxglove_loader_loader_data_loader_t* exports_foxglove_loader_loader_data_loader_rep(
  exports_foxglove_loader_loader_own_data_loader_t handle
);
void exports_foxglove_loader_loader_data_loader_destructor(
