...
extern void __wasm_import_foxglove_loader_console_log(uint8_t *, size_t);

__attribute__((__import_module__("foxglove:loader/console@0.1.0"), __import_name__("error")))
extern void __wasm_import_foxglove_loader_console_error(uint8_t *, size_t);

__attribute__((__import_module__("foxglove:loader/console@0.1.0"), __import_name__("warn")))
extern void __wasm_import_foxglove_loader_console_warn(uint8_t *, size_t);

// Imported Functions from `foxglove:loader/reader@0.1.0`

__attribute__((__import_module__("foxglove:loader/reader@0.1.0"), __import_name__("[method]reader.seek")))
extern int64_t __wasm_import_foxglove_loader_reader_method_reader_seek(int32_t, int64_t);

__attribute__((__import_module__("foxglove:loader/reader@0.1.0"), __import_name__("[method]reader.position")))
extern int64_t __wasm_import_foxglove_loader_reader_method_reader_position(int32_t);

__attribute__((__import_module__("foxglove:loader/reader@0.1.0"), __import_name__("[method]reader.read")))
extern int64_t __wasm_import_foxglove_loader_reader_method_reader_read(int32_t, uint8_t *, size_t);

__attribute__((__import_module__("foxglove:loader/reader@0.1.0"), __import_name__("[method]reader.size")))
...
extern int32_t __wasm_import_foxglove_loader_reader_open(uint8_t *, size_t);

// Exported Functions from `foxglove:loader/loader@0.1.0`

__attribute__((__weak__, __export_name__("cabi_post_foxglove:loader/loader@0.1.0#[method]message-iterator.next")))
void __wasm_export_exports_foxglove_loader_loader_method_message_iterator_next_post_return(uint8_t * arg0) {
...
__attribute__((__weak__, __export_name__("cabi_post_foxglove:loader/loader@0.1.0#[method]data-loader.initialize")))
void __wasm_export_exports_foxglove_loader_loader_method_data_loader_initialize_post_return(uint8_t * arg0) {
  switch ((int32_t) (int32_t) *((uint8_t*) (arg0 + 0))) {
    case 0: {
...
__attribute__((__weak__, __export_name__("cabi_post_foxglove:loader/loader@0.1.0#[method]data-loader.create-iterator")))
void __wasm_export_exports_foxglove_loader_loader_method_data_loader_create_iterator_post_return(uint8_t * arg0) {
  switch ((int32_t) (int32_t) *((uint8_t*) (arg0 + 0))) {
    case 0: {
      break;
    }
...
__attribute__((__weak__, __export_name__("cabi_post_foxglove:loader/loader@0.1.0#[method]data-loader.get-backfill")))
void __wasm_export_exports_foxglove_loader_loader_method_data_loader_get_backfill_post_return(uint8_t * arg0) {
  switch ((int32_t) (int32_t) *((uint8_t*) (arg0 + 0))) {
    case 0: {
...
static uint8_t RET_AREA[(24+6*sizeof(void*))];

// Helper Functions

__attribute__((__import_module__("foxglove:loader/reader@0.1.0"), __import_name__("[resource-drop]reader")))
extern void __wasm_import_foxglove_loader_reader_reader_drop(int32_t handle);
...
foxglove_loader_reader_borrow_reader_t foxglove_loader_reader_borrow_reader(foxglove_loader_reader_own_reader_t arg) {
...
__attribute__((__import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-drop]message-iterator")))
extern void __wasm_import_exports_foxglove_loader_loader_message_iterator_drop(int32_t handle);

void exports_foxglove_loader_loader_message_iterator_drop_own(exports_foxglove_loader_loader_own_message_iterator_t handle) {
  __wasm_import_exports_foxglove_loader_loader_message_iterator_drop(handle.__handle);
}

__attribute__(( __import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-new]message-iterator")))
extern int32_t __wasm_import_exports_foxglove_loader_loader_message_iterator_new(int32_t);

__attribute__((__import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-rep]message-iterator")))
extern int32_t __wasm_import_exports_foxglove_loader_loader_message_iterator_rep(int32_t);

exports_foxglove_loader_loader_own_message_iterator_t exports_foxglove_loader_loader_message_iterator_new(exports_foxglove_loader_loader_message_iterator_t *rep) {
  return (exports_foxglove_loader_loader_own_message_iterator_t) { __wasm_import_exports_foxglove_loader_loader_message_iterator_new((int32_t) rep) };
}

exports_foxglove_loader_loader_message_iterator_t* exports_foxglove_loader_loader_message_iterator_rep(exports_foxglove_loader_loader_own_message_iterator_t handle) {
  return (exports_foxglove_loader_loader_message_iterator_t*) __wasm_import_exports_foxglove_loader_loader_message_iterator_rep(handle.__handle);
}

__attribute__((__export_name__("foxglove:loader/loader@0.1.0#[dtor]message-iterator")))
void __wasm_export_exports_foxglove_loader_loader_message_iterator_dtor(exports_foxglove_loader_loader_message_iterator_t* arg) {
  exports_foxglove_loader_loader_message_iterator_destructor(arg);
}

__attribute__((__import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-drop]data-loader")))
extern void __wasm_import_exports_foxglove_loader_loader_data_loader_drop(int32_t handle);

void exports_foxglove_loader_loader_data_loader_drop_own(exports_foxglove_loader_loader_own_data_loader_t handle) {
  __wasm_import_exports_foxglove_loader_loader_data_loader_drop(handle.__handle);
}

__attribute__(( __import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-new]data-loader")))
extern int32_t __wasm_import_exports_foxglove_loader_loader_data_loader_new(int32_t);

__attribute__((__import_module__("[export]foxglove:loader/loader@0.1.0"), __import_name__("[resource-rep]data-loader")))
extern int32_t __wasm_import_exports_foxglove_loader_loader_data_loader_rep(int32_t);

exports_foxglove_loader_loader_own_data_loader_t exports_foxglove_loader_loader_data_loader_new(exports_foxglove_loader_loader_data_loader_t *rep) {
  return (exports_foxglove_loader_loader_own_data_loader_t) { __wasm_import_exports_foxglove_loader_loader_data_loader_new((int32_t) rep) };
}

exports_foxglove_loader_loader_data_loader_t* exports_foxglove_loader_loader_data_loader_rep(exports_foxglove_loader_loader_own_data_loader_t handle) {
  return (exports_foxglove_loader_loader_data_loader_t*) __wasm_import_exports_foxglove_loader_loader_data_loader_rep(handle.__handle);
}

__attribute__((__export_name__("foxglove:loader/loader@0.1.0#[dtor]data-loader")))
void __wasm_export_exports_foxglove_loader_loader_data_loader_dtor(exports_foxglove_loader_loader_data_loader_t* arg) {
...
uint64_t foxglove_loader_reader_method_reader_seek(foxglove_loader_reader_borrow_reader_t self, uint64_t pos) {
  int64_t ret = __wasm_import_foxglove_loader_reader_method_reader_seek((self).__handle, (int64_t) (pos));
  return (uint64_t) (ret);
}
...
uint64_t foxglove_loader_reader_method_reader_read(foxglove_loader_reader_borrow_reader_t self, host_list_u8_t *target) {
  int64_t ret = __wasm_import_foxglove_loader_reader_method_reader_read((self).__handle, (uint8_t *) (*target).ptr, (*target).len);
  return (uint64_t) (ret);
}
...
uint8_t * __wasm_export_exports_foxglove_loader_loader_method_message_iterator_next(uint8_t * arg) {
  exports_foxglove_loader_loader_result_message_error_t val;
  bool ret = exports_foxglove_loader_loader_method_message_iterator_next(((exports_foxglove_loader_loader_message_iterator_t*) arg), &val);
  ...
  if ((ret0).is_some) {
    ...
    *((int8_t*)(ptr + 0)) = 1;
    if ((*payload1).is_err) {
      const exports_foxglove_loader_loader_error_t *payload3 = &(*payload1).val.err;*((int8_t*)(ptr + 8)) = 1;
      *((size_t*)(ptr + (16+1*sizeof(void*)))) = (*payload3).len;
      *((uint8_t **)(ptr + 16)) = (uint8_t *) (*payload3).ptr;
    } else {
      const exports_foxglove_loader_loader_message_t *payload2 = &(*payload1).val.ok;*((int8_t*)(ptr + 8)) = 0;
...
__attribute__((__export_name__("foxglove:loader/loader@0.1.0#[constructor]data-loader")))
int32_t __wasm_export_exports_foxglove_loader_loader_constructor_data_loader(uint8_t * arg, size_t arg0) {
  exports_foxglove_loader_loader_data_loader_args_t arg1 = (exports_foxglove_loader_loader_data_loader_args_t) {
    (host_list_string_t) (host_list_string_t) { (host_string_t*)(arg), (arg0) },
  };
  exports_foxglove_loader_loader_own_data_loader_t ret = exports_foxglove_loader_loader_constructor_data_loader(&arg1);
  return (ret).__handle;
}

__attribute__((__export_name__("foxglove:loader/loader@0.1.0#[method]data-loader.initialize")))
uint8_t * __wasm_export_exports_foxglove_loader_loader_method_data_loader_initialize(uint8_t * arg) {
  ...
  ret.is_err = !exports_foxglove_loader_loader_method_data_loader_initialize(((exports_foxglove_loader_loader_data_loader_t*) arg), &ok, &err);
  if (ret.is_err) {
    ret.val.err = err;
  }
  if (!ret.is_err) {
  ...
  uint8_t *ptr = (uint8_t *) &RET_AREA;
  if ((ret).is_err) {
    const exports_foxglove_loader_loader_error_t *payload6 = &(ret).val.err;*((int8_t*)(ptr + 0)) = 1;
    *((size_t*)(ptr + (8+1*sizeof(void*)))) = (*payload6).len;
    *((uint8_t **)(ptr + 8)) = (uint8_t *) (*payload6).ptr;
  } else {
    const exports_foxglove_loader_loader_initialization_t *payload = &(ret).val.ok;*((int8_t*)(ptr + 0)) = 0;
...
uint8_t * __wasm_export_exports_foxglove_loader_loader_method_data_loader_create_iterator(uint8_t * arg, int32_t arg0, int64_t arg1, int32_t arg2, int64_t arg3, uint8_t * arg4, size_t arg5) {
  ...
  exports_foxglove_loader_loader_message_iterator_args_t arg7 = (exports_foxglove_loader_loader_message_iterator_args_t) {
    (host_option_time_nanos_t) option,
    (host_option_time_nanos_t) option6,
    (host_list_channel_id_t) (host_list_channel_id_t) { (exports_foxglove_loader_loader_channel_id_t*)(arg4), (arg5) },
  };
  ...
  exports_foxglove_loader_loader_error_t err;
  ret.is_err = !exports_foxglove_loader_loader_method_data_loader_create_iterator(((exports_foxglove_loader_loader_data_loader_t*) arg), &arg7, &ok, &err);
  if (ret.is_err) {
    ret.val.err = err;
  }
  if (!ret.is_err) {
  ...
  uint8_t *ptr = (uint8_t *) &RET_AREA;
  if ((ret).is_err) {
    const exports_foxglove_loader_loader_error_t *payload8 = &(ret).val.err;*((int8_t*)(ptr + 0)) = 1;
    *((size_t*)(ptr + (2*sizeof(void*)))) = (*payload8).len;
    *((uint8_t **)(ptr + sizeof(void*))) = (uint8_t *) (*payload8).ptr;
  } else {
    const exports_foxglove_loader_loader_own_message_iterator_t *payload = &(ret).val.ok;*((int8_t*)(ptr + 0)) = 0;
...
uint8_t * __wasm_export_exports_foxglove_loader_loader_method_data_loader_get_backfill(uint8_t * arg, int64_t arg0, uint8_t * arg1, size_t arg2) {
  exports_foxglove_loader_loader_backfill_args_t arg3 = (exports_foxglove_loader_loader_backfill_args_t) {
    (exports_foxglove_loader_loader_time_nanos_t) (uint64_t) (arg0),
    (host_list_channel_id_t) (host_list_channel_id_t) { (exports_foxglove_loader_loader_channel_id_t*)(arg1), (arg2) },
  };
  exports_foxglove_loader_loader_result_list_message_error_t ret;
  exports_foxglove_loader_loader_list_message_t ok;
  exports_foxglove_loader_loader_error_t err;
  ret.is_err = !exports_foxglove_loader_loader_method_data_loader_get_backfill(((exports_foxglove_loader_loader_data_loader_t*) arg), &arg3, &ok, &err);
  if (ret.is_err) {
    ret.val.err = err;
  }
  if (!ret.is_err) {
  ...
  uint8_t *ptr = (uint8_t *) &RET_AREA;
  if ((ret).is_err) {
    const exports_foxglove_loader_loader_error_t *payload4 = &(ret).val.err;*((int8_t*)(ptr + 0)) = 1;
    *((size_t*)(ptr + (2*sizeof(void*)))) = (*payload4).len;
    *((uint8_t **)(ptr + sizeof(void*))) = (uint8_t *) (*payload4).ptr;
  } else {
    const exports_foxglove_loader_loader_list_message_t *payload = &(ret).val.ok;*((int8_t*)(ptr + 0)) = 0;
