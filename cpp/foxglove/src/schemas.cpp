...
FoxgloveError ArrowPrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_arrow_primitive c_msg;
  arrowPrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_arrow_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError CameraCalibration::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_camera_calibration c_msg;
  cameraCalibrationToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_camera_calibration_encode(&c_msg, ptr, len, result));
}

FoxgloveError CircleAnnotation::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_circle_annotation c_msg;
  circleAnnotationToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_circle_annotation_encode(&c_msg, ptr, len, result));
}

FoxgloveError Color::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_color_encode(reinterpret_cast<const foxglove_color*>(this), ptr, len, result)
  );
}

FoxgloveError CompressedImage::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_compressed_image c_msg;
  compressedImageToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_compressed_image_encode(&c_msg, ptr, len, result));
}

FoxgloveError CompressedVideo::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_compressed_video c_msg;
  compressedVideoToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_compressed_video_encode(&c_msg, ptr, len, result));
}

FoxgloveError CubePrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_cube_primitive c_msg;
  cubePrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_cube_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError CylinderPrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_cylinder_primitive c_msg;
  cylinderPrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_cylinder_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError FrameTransform::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_frame_transform c_msg;
  frameTransformToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_frame_transform_encode(&c_msg, ptr, len, result));
}

FoxgloveError FrameTransforms::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_frame_transforms c_msg;
  frameTransformsToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_frame_transforms_encode(&c_msg, ptr, len, result));
}

FoxgloveError GeoJSON::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_geo_json c_msg;
  geoJSONToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_geo_json_encode(&c_msg, ptr, len, result));
}

FoxgloveError Grid::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_grid c_msg;
  gridToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_grid_encode(&c_msg, ptr, len, result));
}

FoxgloveError ImageAnnotations::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_image_annotations c_msg;
  imageAnnotationsToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_image_annotations_encode(&c_msg, ptr, len, result));
}

FoxgloveError KeyValuePair::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_key_value_pair c_msg;
  keyValuePairToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_key_value_pair_encode(&c_msg, ptr, len, result));
}

FoxgloveError LaserScan::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_laser_scan c_msg;
  laserScanToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_laser_scan_encode(&c_msg, ptr, len, result));
}

FoxgloveError LinePrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_line_primitive c_msg;
  linePrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_line_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError LocationFix::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_location_fix c_msg;
  locationFixToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_location_fix_encode(&c_msg, ptr, len, result));
}

FoxgloveError LocationFixes::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_location_fixes c_msg;
  locationFixesToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_location_fixes_encode(&c_msg, ptr, len, result));
}

FoxgloveError Log::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_log c_msg;
  logToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_log_encode(&c_msg, ptr, len, result));
}

FoxgloveError ModelPrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_model_primitive c_msg;
  modelPrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_model_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError PackedElementField::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_packed_element_field c_msg;
  packedElementFieldToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_packed_element_field_encode(&c_msg, ptr, len, result));
}

FoxgloveError Point2::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_point2_encode(reinterpret_cast<const foxglove_point2*>(this), ptr, len, result)
  );
}

FoxgloveError Point3::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_point3_encode(reinterpret_cast<const foxglove_point3*>(this), ptr, len, result)
  );
}

FoxgloveError PointCloud::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_point_cloud c_msg;
  pointCloudToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_point_cloud_encode(&c_msg, ptr, len, result));
}

FoxgloveError PointsAnnotation::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_points_annotation c_msg;
  pointsAnnotationToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_points_annotation_encode(&c_msg, ptr, len, result));
}

FoxgloveError Pose::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_pose c_msg;
  poseToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_pose_encode(&c_msg, ptr, len, result));
}

FoxgloveError PoseInFrame::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_pose_in_frame c_msg;
  poseInFrameToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_pose_in_frame_encode(&c_msg, ptr, len, result));
}

FoxgloveError PosesInFrame::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_poses_in_frame c_msg;
  posesInFrameToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_poses_in_frame_encode(&c_msg, ptr, len, result));
}

FoxgloveError Quaternion::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_quaternion_encode(reinterpret_cast<const foxglove_quaternion*>(this), ptr, len, result)
  );
}

FoxgloveError RawAudio::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_raw_audio c_msg;
  rawAudioToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_raw_audio_encode(&c_msg, ptr, len, result));
}

FoxgloveError RawImage::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_raw_image c_msg;
  rawImageToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_raw_image_encode(&c_msg, ptr, len, result));
}

FoxgloveError SceneEntity::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_scene_entity c_msg;
  sceneEntityToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_scene_entity_encode(&c_msg, ptr, len, result));
}

FoxgloveError SceneEntityDeletion::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_scene_entity_deletion c_msg;
  sceneEntityDeletionToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_scene_entity_deletion_encode(&c_msg, ptr, len, result));
}

FoxgloveError SceneUpdate::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_scene_update c_msg;
  sceneUpdateToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_scene_update_encode(&c_msg, ptr, len, result));
}

FoxgloveError SpherePrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_sphere_primitive c_msg;
  spherePrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_sphere_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError TextAnnotation::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_text_annotation c_msg;
  textAnnotationToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_text_annotation_encode(&c_msg, ptr, len, result));
}

FoxgloveError TextPrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_text_primitive c_msg;
  textPrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_text_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError TriangleListPrimitive::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_triangle_list_primitive c_msg;
  triangleListPrimitiveToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_triangle_list_primitive_encode(&c_msg, ptr, len, result));
}

FoxgloveError Vector2::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_vector2_encode(reinterpret_cast<const foxglove_vector2*>(this), ptr, len, result)
  );
}

FoxgloveError Vector3::encode(uint8_t* ptr, size_t len, size_t* result) {
  return FoxgloveError(
    foxglove_vector3_encode(reinterpret_cast<const foxglove_vector3*>(this), ptr, len, result)
  );
}

FoxgloveError VoxelGrid::encode(uint8_t* ptr, size_t len, size_t* result) {
  Arena arena;
  foxglove_voxel_grid c_msg;
  voxelGridToC(c_msg, *this, arena);
  return FoxgloveError(foxglove_voxel_grid_encode(&c_msg, ptr, len, result));
}
