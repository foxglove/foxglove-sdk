...
struct CompressedAudio {
  ...
  ///   - Each message must contain raw G.726 codewords without WAV, RTP, or other container framing
  ///   and end on a complete codeword group. Codeword groups may not span messages.
