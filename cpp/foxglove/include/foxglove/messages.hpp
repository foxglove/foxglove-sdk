...
struct CompressedAudio {
  ...
  /// @brief Audio format. Both 'opus' and 'mp4a.40.2' are currently supported.
  std::string format;
  ...
  ///
  /// - `opus`
  ///   - Each message should contain a complete raw Opus packet, without Ogg, WebM, or other
  ///   container framing, as described in https://datatracker.ietf.org/doc/html/rfc6716#section-3.
  /// - `mp4a.40.2`
  ///   - Each message should contain a complete MPEG-4 AAC LC ADTS frame, including the ADTS
  ///   header, as described in section 1.A.3.2 of ISO/IEC 14496-3:2019.
  ///
  /// Any combination of sample rate and number of channels allowed by the respective audio format
  /// is supported.
  ///
