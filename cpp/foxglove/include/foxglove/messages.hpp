...
struct CompressedAudio {
  ...
  ///   - Codewords may cross octet boundaries, so each message must end on a complete octet: its
  ///   length must be a multiple of 1, 3, 1, or 5 octets for `g726-16`, `g726-24`, `g726-32`, and
  ///   `g726-40` respectively, holding 4, 8, 2, or 8 codewords.
