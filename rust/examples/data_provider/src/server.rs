//! Axum handlers and router for the data provider example.
...
///
/// Exposed as a standalone function so that integration tests can construct
/// the same router without duplicating handler code.
pub fn app() -> Router {
    Router::new()
