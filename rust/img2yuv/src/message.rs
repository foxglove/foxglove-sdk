...
impl TryFrom<foxglove::schemas::CompressedImage> for ImageMessage<'static> {
    type Error = UnknownCompressionError;

    fn try_from(
        image: foxglove::schemas::CompressedImage,
...
impl TryFrom<foxglove::schemas::RawImage> for ImageMessage<'static> {
    type Error = UnknownEncodingError;

    fn try_from(image: foxglove::schemas::RawImage) -> std::result::Result<Self, Self::Error> {
