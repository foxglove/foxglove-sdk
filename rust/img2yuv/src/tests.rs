...
use crate::{BayerCfa, Endian, Error, Image, RawImage, RawImageEncoding, Yuv420Buffer, Yuv420Vec};
#[cfg(any(feature = "jpeg", feature = "png", feature = "webp"))]
use crate::{CompressedImage, Compression};
...
impl TestImage {
    ...
    fn to_yuv420(&self) -> Result<Yuv420Vec, crate::Error> {
