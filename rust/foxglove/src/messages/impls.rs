...
impl Encode for RobotDescription {
    type Error = ::prost::EncodeError;

    fn get_schema() -> Option<Schema> {
        Some(Schema::new(
            "foxglove.RobotDescription",
            "protobuf",
            descriptors::ROBOT_DESCRIPTION,
        ))
    }
...
#[doc(hidden)]
impl Decode for RobotDescription {
    type Error = ::prost::DecodeError;
...
#[cfg(feature = "derive")]
impl ProtobufField for RobotDescription {
    fn field_type() -> ::prost_types::field_descriptor_proto::Type {
        ::prost_types::field_descriptor_proto::Type::Message
    }
    ...
    fn type_name() -> Option<String> {
        Some(".foxglove.RobotDescription".to_string())
    }

    fn file_descriptors() -> Vec<::prost_types::FileDescriptorProto> {
        let fds = ::prost_types::FileDescriptorSet::decode(descriptors::ROBOT_DESCRIPTION)
            .expect("invalid file descriptor set");
        fds.file
    }
