...
impl Encode for EventProperty {
    type Error = ::prost::EncodeError;

    fn get_schema() -> Option<Schema> {
        Some(Schema::new(
            "foxglove.EventProperty",
            "protobuf",
            descriptors::EVENT_PROPERTY,
        ))
    }
...
#[cfg(feature = "derive")]
impl ProtobufField for EventProperty {
    fn field_type() -> ::prost_types::field_descriptor_proto::Type {
        ::prost_types::field_descriptor_proto::Type::Message
    }
    ...
    fn type_name() -> Option<String> {
        Some(".foxglove.EventProperty".to_string())
    }

    fn file_descriptors() -> Vec<::prost_types::FileDescriptorProto> {
        let fds = ::prost_types::FileDescriptorSet::decode(descriptors::EVENT_PROPERTY)
            .expect("invalid file descriptor set");
        fds.file
    }
...
#[cfg(feature = "derive")]
impl ProtobufField for EventType {
    fn field_type() -> ::prost_types::field_descriptor_proto::Type {
        ::prost_types::field_descriptor_proto::Type::Message
    }
    ...
    fn type_name() -> Option<String> {
        Some(".foxglove.EventType".to_string())
    }

    fn file_descriptors() -> Vec<::prost_types::FileDescriptorProto> {
        let fds = ::prost_types::FileDescriptorSet::decode(descriptors::EVENT_TYPE)
            .expect("invalid file descriptor set");
        fds.file
    }
