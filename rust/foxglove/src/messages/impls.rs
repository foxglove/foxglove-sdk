...
impl Encode for SelectedEntity {
    type Error = ::prost::EncodeError;

    fn get_schema() -> Option<Schema> {
        Some(Schema::new(
            "foxglove.SelectedEntity",
            "protobuf",
            descriptors::SELECTED_ENTITY,
        ))
    }
...
#[doc(hidden)]
impl Decode for SelectedEntity {
    type Error = ::prost::DecodeError;
...
#[cfg(feature = "derive")]
impl ProtobufField for SelectedEntity {
    fn field_type() -> ::prost_types::field_descriptor_proto::Type {
        ::prost_types::field_descriptor_proto::Type::Message
    }
    ...
    fn type_name() -> Option<String> {
        Some(".foxglove.SelectedEntity".to_string())
    }

    fn file_descriptors() -> Vec<::prost_types::FileDescriptorProto> {
        let fds = ::prost_types::FileDescriptorSet::decode(descriptors::SELECTED_ENTITY)
            .expect("invalid file descriptor set");
        fds.file
    }
