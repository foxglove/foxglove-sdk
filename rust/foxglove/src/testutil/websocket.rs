...
use crate::ChannelId;
use crate::websocket::{
    ChannelView, Client, ClientChannel, ClientChannelId, ClientId, GetParametersResponder,
    Parameter, ParameterHandler, ServerListener, SetParametersResponder,
};
...
impl ParameterHandler<Client> for RecordingParameterHandler {
    fn get(
        &self,
        client: Client,
        names: Vec<String>,
