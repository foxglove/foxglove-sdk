...
use super::{
    AssetHandler, Capability, Client, ClientId, ConnectionGraph, Parameter, ParameterHandler,
...
pub(crate) struct ServerOptions {
    ...
    pub parameter_handler: Option<Arc<dyn ParameterHandler<Client>>>,
...
pub(crate) struct Server {
    ...
    parameter_handler: Option<Arc<dyn ParameterHandler<Client>>>,
    /// Client tasks.
...
impl Server {
    ...
    pub(super) fn parameter_handler(&self) -> Option<&dyn ParameterHandler<Client>> {
