...
// after_includes
pub use foxglove::Channel as FoxgloveRawChannel;
...
pub unsafe extern "C" fn foxglove_channel_create(
    ...
    let channel = match schema {
        FoxgloveBuiltinSchema::Vector3 => builder.build_typed().map(FoxgloveChannel::Vector3),
    };
...
pub extern "C" fn foxglove_channel_get_id(channel: Option<&FoxgloveChannel>) -> u64 {
    ...
    u64::from(match channel {
        FoxgloveChannel::Vector3(channel) => channel.id(),
    })
}
...
pub unsafe extern "C" fn foxglove_channel_log(
    ...
    match channel {
        FoxgloveChannel::Vector3(channel) => {
