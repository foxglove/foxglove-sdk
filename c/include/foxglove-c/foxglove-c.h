 ...
 */
typedef struct foxglove_robot_description {
  /**
 ...
 * We're trusting the caller that the channel will only be used with this type T.
 */
foxglove_error foxglove_channel_create_robot_description(struct foxglove_string topic,
                                                         const struct foxglove_context *context,
                                                         const struct foxglove_channel **channel);
 ...
 */
foxglove_error foxglove_channel_log_robot_description(const struct foxglove_channel *channel,
                                                      const struct foxglove_robot_description *msg,
                                                      const uint64_t *log_time,
                                                      FoxgloveSinkId sink_id);
#endif
 ...
 * All buffers in the returned schema are statically allocated.
 */
struct foxglove_schema foxglove_robot_description_schema(void);
 ...
 * ptr must be a valid pointer to a memory region at least len bytes long.
 */
foxglove_error foxglove_robot_description_encode(const struct foxglove_robot_description *msg,
                                                 uint8_t *ptr,
                                                 size_t len,
                                                 size_t *encoded_len);
