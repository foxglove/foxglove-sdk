...
build-cpp-dist:
	...
	# The dist config includes foxglove-static-platform-links.cmake (also used by the
	# in-tree build and local-install config) and foxglove-sources.cmake (also used by
	# the in-tree build) from the same directory.
