...
export const FrameTransform = {
  ...
  "description": "A transform between two reference frames in 3D space. This transform can be used to convert the coordinates of a point from the child frame to the parent frame. Foxglove applies the translation first and then the rotation: P_parent = rotation * (P_child + translation).",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "timestamp": {
