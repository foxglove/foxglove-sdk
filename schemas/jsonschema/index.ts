...
export const FrameTransform = {
  ...
  "description": "A transform between two reference frames in 3D space. The transform describes the position and orientation of the child frame relative to the parent frame.",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "timestamp": {
    ...
    "rotation": {
      "title": "foxglove.Quaternion",
      "description": "Rotation component of the transform: the orientation of the child frame's axes relative to the parent frame",
      "type": "object",
      "properties": {
        "x": {
          "type": "number",
