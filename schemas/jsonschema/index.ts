...
export const CompressedPointCloud = {
  ...
  "description": "A compressed point cloud. After decompressing `data` using `format`, interpret the resulting bytes using `fields` and `point_stride` exactly as you would for `PointCloud.data`.",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "timestamp": {
    ...
    "data": {
      "type": "string",
      "contentEncoding": "base64",
      "description": "Compressed point cloud data for exactly one point cloud. The payload must contain enough information for a decoder to determine the point count; consumers should not derive it from `data.length / point_stride`."
    },
    "format": {
      "type": "string",
