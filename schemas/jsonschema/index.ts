...
export const RobotDescription = {
  "title": "foxglove.RobotDescription",
  "description": "A robot description used to visualize an articulated 3D model. The description defines its own coordinate frames; the pose of each link is determined by the transform tree or by `foxglove.JointStates` messages.",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "url": {
      "type": "string",
      "description": "URL pointing to the robot description file. One of `url` or `data` should be non-empty. Relative resources referenced by the description, such as meshes, are resolved against this URL."
    },
    "data": {
      "type": "string",
      "contentEncoding": "base64",
      "description": "Embedded robot description. One of `url` or `data` should be non-empty. Because an embedded description has no location to resolve against, any resources it references, such as meshes, must use absolute URLs."
    },
    "format": {
      "type": "string",
