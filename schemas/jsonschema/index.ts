...
export const JointState = {
  ...
  "properties": {
    ...
    "position": {
      "type": "number",
      "description": "Joint position. Radians for revolute joints, meters for prismatic joints. Use NaN to indicate that the value is not present, in case your encoding does not support optional fields."
    },
    "velocity": {
      "type": "number",
      "description": "Joint velocity. Rad/s for revolute joints, m/s for prismatic joints. Use NaN to indicate that the value is not present, in case your encoding does not support optional fields."
    },
    "acceleration": {
      "type": "number",
      "description": "Joint acceleration. Rad/s² for revolute joints, m/s² for prismatic joints. Use NaN to indicate that the value is not present, in case your encoding does not support optional fields."
    },
    "effort": {
      "type": "number",
      "description": "Joint effort (force or torque). Nm for revolute joints, N for prismatic joints. Use NaN to indicate that the value is not present, in case your encoding does not support optional fields."
    }
  },
  "required": [
    "name"
...
export const JointStates = {
  ...
  "description": "The state of a set of joints at a given time. All joint states in one message are recorded at the same time.",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "timestamp": {
