...
export const RawAudio = {
  ...
  "properties": {
    ...
    "format": {
      "type": "string",
      "description": "Audio format. Values defined by this schema are `pcm-s16`, `g711-alaw`, and `g711-ulaw`. Consumers may support a subset of these formats."
    },
    "sample_rate": {
      "type": "integer",
      "minimum": 0,
    ...
    "number_of_channels": {
      "type": "integer",
      "minimum": 0,
      "description": "Number of channels in the audio block. For G.711 formats, this must be greater than zero."
    }
  },
  "required": [
    "timestamp",
