...
export const FrameTransform = {
  ...
  "description": "A transform between two reference frames in 3D space. This transform can be used to convert the coordinates of a point from the child frame to the parent frame.",
  "$comment": "Generated by https://github.com/foxglove/foxglove-sdk",
  "type": "object",
  "properties": {
    "timestamp": {
    ...
    "rotation": {
      "title": "foxglove.Quaternion",
      "description": "Rotation component of the transform: the rotation to apply to convert a point from the child frame to the parent frame",
      "type": "object",
      "properties": {
        "x": {
          "type": "number",
