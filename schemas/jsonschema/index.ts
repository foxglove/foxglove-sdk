...
export const CompressedPointCloud = {
  ...
  "properties": {
    ...
    "point_stride": {
      "type": "integer",
      "minimum": 0,
      "description": "Number of bytes between points in the decoded `data`. This matches the decoded layout described by `fields`, not the codec bitstream layout."
    },
    "fields": {
      "type": "array",
      "items": {
      ...
      "description": "Fields in the decoded `data`. At least 2 coordinate fields from `x`, `y`, and `z` are required for each point's position; `red`, `green`, `blue`, and `alpha` are optional for customizing each point's color."
    },
    "data": {
      "type": "string",
      "contentEncoding": "base64",
