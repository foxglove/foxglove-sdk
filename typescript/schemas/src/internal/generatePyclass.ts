...
export function generatePySchemaModule(schemas: FoxgloveSchema[]): string {
  ...
  const headers = [
    ...
    "",
    "Note that the schema classes are currently immutable and do not expose getters and setters for their fields.",
    "This is a limitation we plan to address in the future.",
    `"""`,
    "# Generated by https://github.com/foxglove/foxglove-sdk",
    "",
