     ...
     impl ExampleMessage {
         ...
         fn new(
             ...
             Self(foxglove::schemas::ExampleMessage {
                 ...
                 field_uint32,
                 field_string,
                 field_duration_array: field_duration_array.into_iter().map(|x| x.into()).collect(),
                 field_time_array: field_time_array.into_iter().map(|x| x.into()).collect(),
                 field_boolean_array,
                 field_bytes_array: field_bytes_array.map(|x| Bytes::copy_from_slice(x.as_bytes())).unwrap_or_default(),
                 field_float64_array,
                 field_uint32_array,
                 field_string_array,
                 field_duration_fixed_array: field_duration_fixed_array.into_iter().map(|x| x.into()).collect(),
                 field_time_fixed_array: field_time_fixed_array.into_iter().map(|x| x.into()).collect(),
